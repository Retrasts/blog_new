...
export default class IMenu extends Vue {
  ...
  public prepareRemove(instance: IIMenu): void {
  ...
  public removeIMenu(): void {
    this.iMenuService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('blogNewApp.iMenu.deleted', { param: this.removeId });
