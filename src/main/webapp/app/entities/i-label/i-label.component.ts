...
export default class ILabel extends mixins(JhiDataUtils) {
  ...
  public iLabels: IILabel[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllILabels();
  }
  ...
  public retrieveAllILabels(): void {
  ...
  public prepareRemove(instance: IILabel): void {
  ...
  public removeILabel(): void {
    this.iLabelService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('blogNewApp.iLabel.deleted', { param: this.removeId });
