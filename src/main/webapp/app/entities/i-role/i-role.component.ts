...
export default class IRole extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IIRole): void {
  ...
  public removeIRole(): void {
    this.iRoleService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('blogNewApp.iRole.deleted', { param: this.removeId });
