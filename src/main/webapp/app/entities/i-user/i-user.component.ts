...
export default class IUser extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IIUser): void {
  ...
  public removeIUser(): void {
    this.iUserService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('blogNewApp.iUser.deleted', { param: this.removeId });
