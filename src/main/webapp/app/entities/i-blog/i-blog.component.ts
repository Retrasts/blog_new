...
export default class IBlog extends mixins(JhiDataUtils) {
  ...
  public iBlogs: IIBlog[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllIBlogs();
  }
  ...
  public prepareRemove(instance: IIBlog): void {
  ...
  public removeIBlog(): void {
    this.iBlogService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('blogNewApp.iBlog.deleted', { param: this.removeId });
